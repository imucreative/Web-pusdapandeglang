...
?>
						<img src="dist/img/fotoMember/<?php echo $fileName; ?>" alt="<?php echo $fileName; ?>" style="margin-top:5px; margin-left:5px; margin-right:5px; margin-bottom:5px; width:170px; height:220px; border:2px solid;">
<?php
					}
				}
			}
